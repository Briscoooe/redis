...
[![Build Status](https://travis-ci.org/Briscoooe/redis.png?branch=master)](https://travis-ci.org/Briscoooe/redis)
[![GoDoc](https://godoc.org/github.com/Briscoooe/redis?status.svg)](https://godoc.org/github.com/Briscoooe/redis)
...
- [Pub/Sub](https://godoc.org/github.com/Briscoooe/redis#PubSub).
- [Transactions](https://godoc.org/github.com/Briscoooe/redis#Multi).
- [Pipeline](https://godoc.org/github.com/Briscoooe/redis#example-Client-Pipeline) and [TxPipeline](https://godoc.org/github.com/Briscoooe/redis#example-Client-TxPipeline).
- [Scripting](https://godoc.org/github.com/Briscoooe/redis#Script).
- [Timeouts](https://godoc.org/github.com/Briscoooe/redis#Options).
- [Redis Sentinel](https://godoc.org/github.com/Briscoooe/redis#NewFailoverClient).
- [Redis Cluster](https://godoc.org/github.com/Briscoooe/redis#NewClusterClient).
- [Ring](https://godoc.org/github.com/Briscoooe/redis#NewRing).
- [Instrumentation](https://godoc.org/github.com/Briscoooe/redis#ex-package--Instrumentation).
- [Cache friendly](https://github.com/Briscoooe/cache).
- [Rate limiting](https://github.com/Briscoooe/redis_rate).
- [Distributed Locks](https://github.com/bsm/redis-lock).

API docs: https://godoc.org/github.com/Briscoooe/redis.
Examples: https://godoc.org/github.com/Briscoooe/redis#pkg-examples.
...
```shell
go get -u github.com/Briscoooe/redis
```

Import:

```go
import "github.com/Briscoooe/redis"
```
...
Please go through [examples](https://godoc.org/github.com/Briscoooe/redis#pkg-examples) to get an idea how to use this package.
